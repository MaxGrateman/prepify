...
export default function Home() {
  ...
  <div>
    <div className="relative h-screen text-left w-screen">
      <AnimatePresence>
        <motion.h1
          className="absolute text-7xl bottom-0 left-5 flex items-center cursor-pointer"
    ...
    <div className="mt-20 mx-5 w-[50%] flex flex-col">
          ...
          <button className="mt-5 italic text-2xl self-end
          text-white bg-primary-black border-2 border-white hover:bg-white focus:outline-none focus:ring-1 focus:ring-white
            font-medium rounded-3xl px-8 me-4 mb-4 shadow-md shadow-neutral-100/50">
              CLICK
          </button>
    </div>
    <div className="h-96">
