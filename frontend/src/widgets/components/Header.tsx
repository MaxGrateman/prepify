                ...
                <div className="flex items-center justify-end space-x-2">
                    ...
                    {!user ? (
                             <>
                                 ...
                                 <Link href="/register">
                                    <button type="button" className="text-gray-900 bg-white focus:outline-none hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-violet-500 dark:text-white dark:hover:bg-violet-700 dark:focus:ring-gray-700">
                                        Sign in
                                    </button>
                                 </Link>
                             </>
