            ...
            {loading ? (
                ...
                <div className="flex flex-col items-center -mt-20 z-20 gap-1 relative transform hover:rotate-x-15 hover:rotate-y-30 transition-transform duration-500">
                    ...
                    <div className="flex flex-col items-center my-2">
                        ...
                        <p className='text-lg tracking-wider text-gray-500'>{user?.email}</p>
                    </div>

                    
                    <div className="relative z-0 w-full mb-5 group">
                        <input type="text" name="floating_name" id="floating_name" className="block font-medium tracking-wider py-2.5 px-0 w-full text-xl text-gray-600 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-violet-500 focus:outline-none focus:ring-0 focus:border-violet-600 peer" 
                        placeholder=" " value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} disabled={!isEditing} required/>
                        <label htmlFor="floating_name" className="peer-focus:font-medium absolute text-xl tracking-wider text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-violet-600 peer-focus:dark:text-violet-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                        NAME</label>
                    </div>
                    <div className="relative z-0 w-full mb-5 group">
                        <input type="number" name="floating_age" id="floating_age" className="block font-medium tracking-wider py-2.5 px-0 w-full text-xl text-gray-600 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-violet-500 focus:outline-none focus:ring-0 focus:border-violet-600 peer" 
                        placeholder=" " value={formData.age || ''} onChange={(e) => setFormData({...formData, age: e.target.value === '' ? null : Number(e.target.value),})} 
                        disabled={!isEditing} 
                        required/>
                        <label htmlFor="floating_age" className="peer-focus:font-medium absolute text-lg tracking-wider text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-violet-600 peer-focus:dark:text-violet-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                        AGE</label>
                    </div>
                    <div className="relative z-0 w-full mb-5 group">
                        ...
                        placeholder=" " value={formData.level || ''} onChange={(e) => setFormData({ ...formData, level: e.target.value })} disabled={!isEditing} required/>
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        ...
                        placeholder=" " value={formData.stack || ''} onChange={(e) => setFormData({ ...formData, stack: e.target.value })} disabled={!isEditing} required/>
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        ...
                        placeholder=" " value={formData.country || ''} onChange={(e) => setFormData({ ...formData, country: e.target.value })} disabled={!isEditing} required/>
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        ...
                        placeholder=" " value={formData.about || ''} onChange={(e) => setFormData({ ...formData, about: e.target.value })} disabled={!isEditing} required/>
                    ...
                    <div className="flex-1 flex flex-col items-center px-8 mt-2">
                        <div className="absolute -bottom-[20x] flex items-center space-x-4">
                            {!isEditing ? ( 
